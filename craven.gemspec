...
Gem::Specification.new do |spec|
  ...
  spec.add_development_dependency "bourbon", "~> 3.1.4"
  spec.add_development_dependency "neat", "~> 1.3.0"
  spec.add_runtime_dependency "bourbon", "~> 3.1.4"
  spec.add_runtime_dependency "neat", "~> 1.3.0"
end
